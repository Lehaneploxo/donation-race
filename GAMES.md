...
| 📺 Fantasy Arena TV | `/fantasyarenatv` | `client/fantasy_arena_tv.html` | 12-я программа (08.09.2026). Та же Fantasy Arena, но в ТВ-формате: канвас 1280×720 (16:9) вместо портретных 600×1000. Правила, карты (те же 8 фонов), герои, уровни (1-100) и ежедневный сброс — 1-в-1 как в портретной версии. Отличия: верхней плашки с правилами и плашки «ТОП ДНЯ» НЕТ (арена во весь экран, сверху только титр «FANTASY ARENA» + creator); СВОЯ отдельная база (`fantasyarenatv_*`), рейтинг/уровни НЕ смешиваются с `/fantasyarena`; ринг шире в ~2.5 раза, поэтому скорость ходьбы умножена на `SPEED_SCALE = 1.6` (единственная ручка частоты стычек). Чат-команды те же: «rating», «hero1»-«hero4» (выбор героя пишется в обе базы сразу) |
| 📊 Fantasy Arena TV — база данных | `/fantasyarenatv-db` | `client/fantasy_arena_tv_db.html` | |
